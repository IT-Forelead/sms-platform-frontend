  ...
  <div class="bg-white rounded-lg p-3 px-5 mt-3 max-content-h">
    ...
    <form @submit.prevent="createContact">
      ...
      <div class="mb-6">
        ...
        <input type="text" id="phone-input" v-model="phone_" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Telefon raqamni kiriting..." />
      </div>
      <hr class="border-gray-200 border-dotted bottom-1 mb-6" />
